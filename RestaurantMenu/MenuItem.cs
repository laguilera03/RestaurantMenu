...
namespace RestaurantMenu
{
    class MenuItem
    {
        ...
        /*
         * ***Menu should be the class holding all the items price, description, and category, including the date (to match with date last modified), privately, and the date it was last modified
         */
    }
}